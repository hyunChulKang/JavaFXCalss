...
public class T18_BarChartTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		// X축 , Y축 이용한Chart는 해당 축 객체를 생성한다.
		
		// 축의 값이 주로 문자열 일때 사용하는 객체
		...
		//BarCahrt에 나타날 데이터 구성하기
		XYChart.Series<String, Number> ser1 = new XYChart.Series<>();			//내부 클래스 이며 Series  XYChart에서만 사용한다.
